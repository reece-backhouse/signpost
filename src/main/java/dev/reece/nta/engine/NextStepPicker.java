...
/**
 * "Do this next" (ticket E3): picks one unmet requirement from a {@link GoalStatus}, in order
 * (a) a start-here quest prereq, (b) the smallest-xp-delta skill gap with a bank-covered route
 * (C6), (c) the smallest-xp-delta skill gap overall with its partial route, (d) the first missing
