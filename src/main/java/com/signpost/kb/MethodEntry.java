 ...
 * exist only so {@link com.signpost.engine.RoutePlanner} and
 * {@link com.signpost.engine.ShortfallResolver} can recurse one level into them when a real
...
public class MethodEntry
{
	...
	/** The method's wiki page: a skill-calc row is named after the item it makes or acts on. */
