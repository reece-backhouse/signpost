 ...
 * {@link com.signpost.engine.GapEngine#sourcesFor} filtering on {@code type == "GE"} already does
...
public class MaterialEntry
{
	String name;
	Integer id;
	/** True when the name is a prose/category reference ("Pickaxe", "Combat gear") with no item id: never a bank-matchable {@link com.signpost.engine.model.ItemGap}, always a note. */
	boolean generic;
	/** The item's wiki page, from kb-build or derived from the name. */
	String wikiUrl;
