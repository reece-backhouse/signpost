...
/**
 * Image-only access to RuneLite's item and skill icon caches for the panels, plus the
...
public class Icons
{
	...
	/** Text fallback for {@link #quest} when the world-map icon isn't loadable; ASCII, since the RuneScape font has no marker glyphs. */
