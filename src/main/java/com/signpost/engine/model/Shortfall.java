...
/**
 * What's missing to close a {@link Route}'s {@code uncoveredXp}: the fastest method at
 ...
 * UI can print "~403,000 xp: Prayer potion(3) ×4,600". {@code alternative} is the
 ...
 * {@code alternative} is always {@code null}. {@code unobtainable} names the materials
...
public class Shortfall
{
	...
	public Shortfall(MethodEntry method, List<ShortfallItem> items, long xpShort, long actionsNeeded, Shortfall alternative,
		List<String> unobtainable)
	{
		this(method, items, xpShort, actionsNeeded, alternative, unobtainable, List.of());
	}

	public Shortfall(MethodEntry method, List<ShortfallItem> items, long xpShort, long actionsNeeded, Shortfall alternative,
		List<String> unobtainable, List<String> notes)
	{
		this.method = method;
		this.items = items;
