...
/**
 * The time left to a skill target at the player's observed xp rate.
 * Pure arithmetic over data the plugin passes in ({@link com.signpost.engine.model.Advice#getXpPerHour()}).
 */
